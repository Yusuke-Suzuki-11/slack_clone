                    ...
                    <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
                        ...
                        <form className="max-w-lg border rounded-lg mx-auto">
                            <div className="flex flex-col gap-4 p-4 md:p-8">
                                ...
                                <button type="submit" onClick={(e) => handleSignInSubmit(e)} className="block bg-gray-800 hover:bg-gray-700 active:bg-gray-600 focus-visible:ring ring-gray-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">
                                    Log In
                                </button>
